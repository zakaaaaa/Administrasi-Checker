export function CheckLandingDecor() {
  return (
    <>
      ...
      <div
        aria-hidden
        className="check-landing-blob -z-10 left-[-80px] top-[40px] h-72 w-72 bg-orange-300/40"
      />
      <div
        aria-hidden
        className="check-landing-blob -z-10 right-[-60px] top-[200px] h-80 w-80 bg-amber-200/40"
      />
      <div
        aria-hidden
